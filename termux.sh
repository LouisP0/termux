...
function install_zsh() {
	...
	curl -fsLo "$HOME/.oh-my-zsh/themes/lambda-mod.zsh-theme" https://raw.githubusercontent.com/LouisP0/termux/master/.termux/lambda-mod.zsh-theme
	curl -fsLo "$HOME/.zshrc" https://raw.githubusercontent.com/LouisP0/termux/master/.termux/.zshrc
	curl -fsLo "$HOME/.profile" https://raw.githubusercontent.com/LouisP0/termux/master/.termux/.profile
...
function install_requirements() {
	...
	if [ -d "$HOME/.termux" ]; then
		if ask "\\e[32m[ termux ]\\e[m configs found, overwrite?" Y; then
			rm -rf "$HOME/.termux"
			curl -fsLo "$HOME/.termux/colors.properties" --create-dirs https://raw.githubusercontent.com/LouisP0/termux/master/.termux/colors.properties
			curl -fsLo "$HOME/.termux/font.ttf" --create-dirs https://raw.githubusercontent.com/LouisP0/termux/master/.termux/font.ttf
		fi
	else
		curl -fsLo "$HOME/.termux/colors.properties" --create-dirs https://raw.githubusercontent.com/LouisP0/termux/master/.termux/colors.properties
		curl -fsLo "$HOME/.termux/font.ttf" --create-dirs https://raw.githubusercontent.com/LouisP0/termux/master/.termux/font.ttf
...
function install_neovim() {
	...
	curl -fsLo "$HOME/.config/nvim/autoload/plug.vim" --create-dirs https://raw.githubusercontent.com/LouisP0/termux/master/.termux/nvim/autoload/plug.vim
	curl -fsLo "$HOME/.config/nvim/colors/Tomorrow-Night-Eighties.vim" --create-dirs https://raw.githubusercontent.com/LouisP0/termux/master/.termux/nvim/colors/Tomorrow-Night-Eighties.vim
	curl -fsLo "$HOME/.config/nvim/init.vim" --create-dirs https://raw.githubusercontent.com/LouisP0/termux/master/.termux/nvim/init.vim
}
